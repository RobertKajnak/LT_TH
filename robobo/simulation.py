...
#        dt_sim = t_sim - self._prev_sim_time
#        print(float(dt_sim)/float(dt))
#        if dt!=0:
#            duration = millis / 1000.0 * float(dt_sim)/float(dt)
#        else:
#           duration = millis / 1000.0 
#        self._prev_real_time = t
#        self._prev_sim_time = t_sim
...
#        t_prev = int(time.time()*1000)
#        t_prev_sim_time = vrep.simxGetLastCmdTime(self._clientID)
#        time.sleep(0.1)
#        self._vrep_get_ping_time()
#        t_sim = vrep.simxGetLastCmdTime(self._clientID)
#        
#        dt = int(time.time()*1000) - t_prev
#        dt_sim = t_sim -t_prev_sim_time
#        #print(float(dt_sim)/float(dt))
#        print(dt)
#        print(dt_sim)
    ...
    def reset_position(self):
        vrep.simxSetObjectPosition(self._clientID, self._initial_position, -1, self._initial_position, vrep.simx_opmode_blocking)
